...
const ThirdSection = () => {
    return (
        <div className='w-full h-auto max-w-[100em] bg-linear-to-r  from-[#4F39F6] to-[#9514FA] mt-10'>
            <div className='flex flex-col item-centre md:flex md:flex-row items-center justify-center md:space-x-20 '>
                <div className='mt-15 '>
